  ...
  renderUpdateForm() {
    return (
      <form onSubmit={this.handleUpdateClick}>
        ...
        <button type="submit" className="btn btn-primary" disabled={!this.validatEmailForm()}>
          Update Email
        </button>
      </form>
    );
      ...
      <form onSubmit={this.handleConfirmClick}>
        <FormGroup bsSize="large" controlId="code">
          ...
          <HelpBlock>
            ...
            ({this.state.email}) for the confirmation
            code.
          </HelpBlock>
        </FormGroup>


        <button type="submit" className="btn btn-primary" disabled={!this.validateConfirmForm()}>
          Confirm
        </button>
      </form>
    );
